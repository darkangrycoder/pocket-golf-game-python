...
the purpose of the file is to combine the all gaming related file and navigate to one option to another. In this file, I have desighed overall interface of the game. 
...
#config the window & interface of this game 
...
#programming on the characteristics of golf ball 
class ball():
...
# while ball in active, count the scopre and sent it to score.txt to get the results 
    def unlock(self):
...
def getCoins():
 ...
 # code about ball shops and purchasing logics    
...
# overall representation of this game 
